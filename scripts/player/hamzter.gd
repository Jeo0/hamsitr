...
@onready var collision_walking: CollisionShape2D = $collision_walking
@onready var collision_petting: CollisionShape2D = $collision_petting
...
func _ready():
	...
	# _change_state(load("res://scripts/player/states/walkingState.gd").new())
